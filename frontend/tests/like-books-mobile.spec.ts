...
test("should click like on two generated books, and see their icons change color", async ({
  ...
  const thirdBook = books.nth(2);
  await firstBook.getByTestId(/^like-/).tap(); // taps on the like button of the first book
  await secondBook.getByTestId(/^like-/).tap(); // taps on the like button of the second book
...
test("should click like on three generated books, and see their icons change color", async ({
  ...
  await firstBook.getByTestId(/^like-/).tap(); // taps on the like button of the first book
  await secondBook.getByTestId(/^like-/).tap(); // taps on the like button of the second book
  await thirdBook.getByTestId(/^like-/).tap(); // taps on the like button of the third book
