...
class DatabaseInitializer implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    // Books
    // Category categoryFromDb1 =
    // categoryService.findCategoryByName(category1.getName());

    // Book book1 =
    // new Book(
    // "The Canterbury Tales: Seventeen Tales and the General Prologue: A Norton
    // Critical
    ...
    // lesser ones—than any other book I have ever used in any of my classes in my
    // more than a
    ...
    // Category categoryFromDb2 =
    // categoryService.findCategoryByName(category2.getName());
    ...
    // improving--every day. James Clear, one of the world's leading experts on
    // habit formation,
