  ...
  class SignUpTests {
      ...
      given()
        ...
        .body(
          new ObjectMapper().writeValueAsString(
            new UserRequestDTO(email, "r9$CbHEaGXLUsP")
          )
        )
        .when()
        .post("/signup")
    ...
    void signup_whenEmailIsNull_thenReturn400AndBody() {
      ...
      given()
        ...
        .body(
          new ObjectMapper().writeValueAsString(
            new UserRequestDTO(null, "r9$CbHEaGXLUsP")
          )
        )
        .when()
        .post("/signup")
    ...
    void signup_whenEmailIsTooShort_thenReturn400AndBody() {
      ...
      given()
        ...
        .body(
          new ObjectMapper().writeValueAsString(
            new UserRequestDTO("f@b.c", "r9$CbHEaGXLUsP")
          )
        )
        .when()
        .post("/signup")
    ...
    void signup_whenEmailAlreadyExists_thenReturn400AndBody() {
      ...
      Role role = UserControllerTest.this.roleRepository.findByName(
        "ROLE_USER"
      ).orElseThrow();
      ...
      given()
        ...
        .body(
          new ObjectMapper().writeValueAsString(
            new UserRequestDTO(email, password)
          )
        )
        .when()
        .post("/signup")
    ...
    void signup_whenPasswordIsNull_shouldReturn400AndBody() {
      ...
      given()
        ...
        .body(
          new ObjectMapper().writeValueAsString(
            new UserRequestDTO("jurgis@inbox.lt", null)
          )
        )
        .when()
        .post("/signup")
