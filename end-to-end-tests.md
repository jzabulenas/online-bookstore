...
| Backend                                                 | Mobile                                                                                           | Desktop                                                                                          |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| whenCalled_thenReturnBooksAnd200                        |                                                                                                  |                                                                                                  |
...
| getUserBooks_whenUnauthenticated_thenReturn401AndNoBody | Can't replicate                                                                                  | Can't replicate                                                                                  |
|                                                         | should click like on a single generated book, and see it displayed in 'saved books'              | should click like on a single generated book, and see it displayed in 'saved books'              |
|                                                         | should click like on two generated books, and see them displayed in 'saved books'                | should click like on two generated books, and see them displayed in 'saved books'                |
|                                                         | should click like on three generated books, and see them displayed in 'saved books'              | should click like on three generated books, and see them displayed in 'saved books'              |
...
| add unauthenticated tests, check if others have         |                                                                                                  |                                                                                                  |
